$(function () {
  ...
  var conversation_msg_en =
    "Welcome to RockyMegaPro support service. How can i assist you?";
  ...
  function getMenu(type = "conversation") {
    ...
    var menu_msg_en =
      "Hello Rocky Bhai" +
      getCookie("name") +
      "! Hope you are doing well. Welcome to RockyMegaPro support service. How can i assist you?";

    var menu_msg_hi =
      "नमस्ते " +
      getCookie("name") +
      "! आशा है आप अच्छे होंगे. RockyMegaPro समर्थन सेवा में आपका स्वागत है। मैं आपकी सहायता कैसे कर सकता हूँ?";
